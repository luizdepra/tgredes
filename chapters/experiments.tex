...
\section{Comparação da árvore \textit{K-D} com o MySQL} \label{kd_vs_mysql}
	...
	dados são obtidos no monitoramento. Permitindo que requisições sejam 
	respondidas em tempo real, a medida em que chegam ao sistema. Sendo assim,
...
\section{Comparação da árvore \textit{K-D-B} com o MySQL} \label{kdb_vs_mysql}
	...
	experimentos com a operação de inserção. Terminando com a subseção 
