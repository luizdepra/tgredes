...
\label{definicoes}
	...
	Um registro é dito multidimensional quando possui múltiplas chaves, podendo ser representado como um ponto no espaço euclidiano. A pesquisa multidimensional é definida como a busca por múltiplos atributos (chaves). Estruturas de dados multidimensionais indexam e dão suporte a registros multidimensionais.
