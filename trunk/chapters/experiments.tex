...
\label{img_search_4keys_kd_mysql} \end{center} \end{figure}
	...
	A figura \ref{img_search_4keys_kd_mysql} mostra os resultados obtidos na operação de busca com 4 chaves para o MySQL.
	As linhas que representam o tempo de busca na árvore \textit{K-D} foram omitidos, pois
	não apareceriam no gráfico. O tempo de busca medido na árvore \textit{K-D} foi entre 
	0 milissegundos a 10 milissegundos. Além disso, apesar de não ficar visível no
...
\label{img_search_Xkeys_mysql} \end{center} \end{figure}
	...
	testes, o tempo de retorno foi de 0 milissegundos até 10 milissegundos. Ou
