\chapter{Pesquisa Multidimensional}
	...
	A pesquisa multidimensional \cite{gonnet} é definida pela busca de elementos a partir de chaves compostas. Essas chaves compostas são os atributos que definem os elementos dentro do espaço de busca. 
