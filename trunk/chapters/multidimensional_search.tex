...
\section{Árvores \textit{K-D}} \label{kd}
	...
	A árvore \textit{K-D} (\textit{K-Dimensional}) \cite{andreas2, andreas, bentley,
	...
	$K$ chaves. Semelhante ao que ocorre na árvore binária de pesquisa, os
...
$(k_{0},k_{1},k_{2})$.} \end{center} \end{figure}
	...
	\textit{maior ou igual que} a chave correspondente do nó pai.
...
\end{figure}
	...
	e que serão detalhados a seguir são de pesquisa exata e por intervalo.
