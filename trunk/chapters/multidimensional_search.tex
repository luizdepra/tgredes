...
\label{definicoes}
	...
	Um registro é dito multidimensional quando possui múltiplas chaves, podendo ser representado como um ponto no espaço euclidiano. Estruturas de dados multidimensionais indexam e dão suporte a registros multidimensionais. Estas estruturas são comumente conhecidas como métodos de acesso multidimensional \cite{gaede}.
	
% A pesquisa multidimensional é definida como a busca através de múltiplos atributos (chaves). 
