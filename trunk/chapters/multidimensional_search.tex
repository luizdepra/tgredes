...
\end{figure}
	...
	O algoritmo de pesquisa é executado de maneira parecida com o algoritmo de pesquisa da árvore \textit{K-D}. A única diferença é que ao invés de utilizar a chave do nodo atual para a comparação, é usado a mediana entre todos os pontos daquela plano. O algoritmo de inserção para as árvores \textit{K-D adaptativas} segue esse mesmo raciocínio, o que faz com que a árvore se comporte melhor quando os dados são pouco atualizados.
